...
def parse_args():
    ...
    # Directory Setting
    parser.add_argument('--data_dir', type=str, default='./train_data/vimeo_triplet/')
    ...
    parser.add_argument('--loss', type=str, default='1*rec+0.05*occ', help='loss function configuration')
...
def main():
    ...
    train_loader = DataLoader(dataset=train_dataset, batch_size=args.batch_size, num_workers=16, pin_memory=True,
                              sampler=sampler)
